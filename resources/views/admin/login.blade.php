  ...
  <form action="{{ route('dangnhap') }}" method="post">
    ...
    <div class="login">
      <label>
        ...
        <input class="username" type="text" autocomplete="on" name="username" placeholder="Tài khoản"/>
      </label>
      <label>
        <div class="fa fa-commenting"></div>
        <input class="password" type="password" autocomplete="off" name="password" placeholder="Mật khẩu"/>
        <button class="password-button">show</button>
      </label>
      <button class="login-button">Đăng nhập</button>
    </div>
  </form>
  <div class="footer"><a href="{{ route('trangchu') }}">Quay về</a></div>
...
<script  src="{{ asset('front-end/login') }}/script.js"></script>
